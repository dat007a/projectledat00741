...
class PSDCreatorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Simple PSD Creator")
        ...
        self.stroke_h_spacing_var = tk.StringVar(value=str(self.STROKE_HORIZONTAL_SPACING_CM))
    ...
    def reset_fields(self):
        ...
        self.stroke_h_spacing_var.set(str(self.STROKE_HORIZONTAL_SPACING_CM))
